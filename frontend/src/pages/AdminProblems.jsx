                                        ...
                                        <td className="py-3 px-4">
                                            <div className="flex items-center justify-end">
                                                <div className="relative group">
                                                    <button className="text-secondary hover:text-primary transition-colors p-2 rounded-lg hover:bg-dark-bg-secondary/50">
                                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    {/* Dropdown Menu */}
                                                    <div className="absolute right-0 mt-2 w-48 bg-dark-bg-secondary border dark:border-dark-border-primary border-light-border-primary rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-20">
                                                        <div className="p-1">
                                                            <button
                                                                onClick={() => navigate(`/problems/${problem.id}`)}
                                                                className="w-full text-left px-4 py-2 text-sm text-secondary hover:text-primary hover:bg-dark-bg-primary rounded-lg transition-colors flex items-center gap-2"
                                                            >
                                                            ...
                                                            <div className="h-px bg-dark-border-primary my-1 mx-2"></div>
                                                            <button
                                                                onClick={() => setDeleteConfirm(problem.id)}
                                                                className="w-full text-left px-4 py-2 text-sm text-difficulty-hard hover:bg-difficulty-hard/10 rounded-lg transition-colors flex items-center gap-2"
                                                            >
                                                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
