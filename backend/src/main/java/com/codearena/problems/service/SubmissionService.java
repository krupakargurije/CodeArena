...
import com.codearena.problems.dto.SubmissionRequest;
import com.codearena.problems.dto.SubmissionResponse;
...
public class SubmissionService {
    ...
    // â”€â”€â”€ In-Memory Test Case Cache â”€â”€â”€
    ...
    public SubmissionResponse submitCode(SubmissionRequest request, String username) {
        ...
        // Just queue it â€” return immediately
    ...
    public void processSubmission(Long submissionId) {
        ...
        System.out.println("[Worker] Submission " + submissionId + " processed â†’ " + submission.getStatus());
    }
    ...
    private void evaluateUsingZip(Submission submission, String zipUrl) throws Exception {
        ...
        if (bundle == null) {
            System.out.println("[Cache] MISS for problem " + problemId + " â€” downloading ZIP");
            bundle = downloadAndExtractZip(zipUrl);
            testCaseCache.put(problemId, bundle);
        } else {
            System.out.println("[Cache] HIT for problem " + problemId + " â€” using cached test cases");
        }
    ...
    // â”€â”€â”€ Single Test Fallback â”€â”€â”€
    ...
    // â”€â”€â”€ Judge0 Interaction â”€â”€â”€
