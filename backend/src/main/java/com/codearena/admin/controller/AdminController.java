...
public class AdminController {
    ...
    public ResponseEntity<?> grantAdminPermission(@RequestBody com.codearena.admin.dto.GrantAdminRequest request) {
        try {
    ...
    public ResponseEntity<Map<String, Object>> revokeAdminPermission(
            @RequestBody com.codearena.admin.dto.GrantAdminRequest request) {
